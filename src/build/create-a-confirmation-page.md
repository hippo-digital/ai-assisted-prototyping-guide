...
The confirmation page is the last page in the journey. It tells users their report has been submitted and gives them any information they need about what happens next.

GOV.UK confirmation pages use a green panel – the [panel component](https://design-system.service.gov.uk/components/panel/) – with a success heading and a reference number. This gives users clear reassurance that something has happened.
...
```
Create a GOV.UK confirmation page at app/views/confirmation.html.
...
Go to `http://localhost:3000/confirmation`.

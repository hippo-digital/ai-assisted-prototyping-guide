...
<span class="caption">Part 2: Build a prototype</span>
 <h1>Create a start page</h1>

 <p>The start page is the first thing users see. It introduces the service, explains what it does, and has a "Start now" button that begins the journey.</p>

 <p>On GOV.UK, start pages follow a consistent pattern: a clear heading, a short description of the service, bullet points listing what the user will need, and a prominent start button.</p>

 <h2>The prompt</h2>

 <p>In Gemini CLI (Terminal 2), paste the following prompt:</p>

 <div class="code-block"><code>Create a GOV.UK start page for a service called "Report a building issue".
...
Use GOV.UK Frontend classes throughout. The button should use the correct GOV.UK start button markup with the SVG arrow icon.</code></div>

 <p>Gemini will ask permission to create the file. Type <strong>yes</strong>.</p>

 <h2>Check your browser</h2>

 <p>Go to <code>http://localhost:3000/start</code> in your browser.</p>
